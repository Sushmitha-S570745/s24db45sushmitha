...
res.render('index', { title: 'Yogamat App', user : req.user });
});
router.get('/register', function(req, res) {
res.render('register', { title: 'yogamat App Registration'});
});
...
res.render('login', { title: 'yogamat App Login', user : req.user });
});
